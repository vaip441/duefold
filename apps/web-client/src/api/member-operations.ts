/**
 * Processing state, exports, and uploads.
 *
 * Branding is deliberately absent: its requests live in the optional module that
 * owns them, so an installation that omits branding ships no branding request path.
 *
